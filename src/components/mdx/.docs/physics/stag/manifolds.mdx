...
* Many physical questions can be cast as an initial-value problem: given the state of a system at some moment in time, what will be 
...
real numbers:
  ...
  discussion about this you should refer to ***Page 88***)
