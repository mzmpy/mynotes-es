...
export default defineComponent({
  ...
  components: { ElSlider },
    ...
    const initWebGl = () => {
      ...
      const projectionMatrixLocation = gl.getUniformLocation(program, 'u_project_matrix')
      ...
      const dz = parseFloat(formatValue(zPos.value))
      ...
      gl.uniformMatrix4fv(projectionMatrixLocation, false, new Float32Array(projection3d(2, 2, 2)))
      ...
      drawScene()
        ...
        <div class={ styles('vessel') }>
          ...
          <div class={ styles('operation') }>
            ...
            <ElSlider modelValue={ zPos.value } formatTooltip={ formatValue } onUpdate:modelValue={ handleZChange }></ElSlider>
