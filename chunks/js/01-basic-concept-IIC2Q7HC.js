import{a as u,b as v,c as A}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-RCTJX4YQ.js";import{a as L}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-M22WTZSL.js";import{M as y,R as w,ba as N,f as a,g as t,qa as h,ya as R,z as b}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-WBJ4GZYY.js";t();R();t();t();t();R();t();var V={"gl-canvas":{name:"src__components__mdx__constituents__webgl__basic-concept__helloWorld__index-9iqEPq-gl-canvas",composes:[],isReferenced:!1}},T=(l=>s=>{if(typeof s!="string")throw new TypeError("resolveStyles: parameter 'className' must be a string.");return l[s.replace(/[A-Z]/g,n=>"-"+n.toLowerCase())].name})(V);var F=y({name:"WebGLHelloWorld",setup(){let l=b();return w(()=>{let n=l.value.getContext("webgl");if(!n)return;let e=`
