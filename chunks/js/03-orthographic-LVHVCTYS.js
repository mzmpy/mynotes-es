import{a as R,b as T,c as C,e as L,f as S,g as U,h as D,i as V}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-C35OGGPY.js";import{r}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-3K4LOGFD.js";import{a as y}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-IDJP7L6O.js";import{I as t,N as F,ca as b,f as a,g as h,ra as e,z as c,za as E}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-QYRLMMZP.js";h();E();h();h();h();E();h();var us={"gl-canvas":{name:"src__components__mdx__constituents__webgl__orthographic__transformF__index-y8izxq-gl-canvas",composes:[],isReferenced:!1},operation:{name:"src__components__mdx__constituents__webgl__orthographic__transformF__index-y8izxq-operation",composes:[],isReferenced:!1},vessel:{name:"src__components__mdx__constituents__webgl__orthographic__transformF__index-y8izxq-vessel",composes:[],isReferenced:!1}},o=(l=>s=>{if(typeof s!="string")throw new TypeError("resolveStyles: parameter 'className' must be a string.");return l[s.replace(/[A-Z]/g,j=>"-"+j.toLowerCase())].name})(us);var B=t({name:"WebGLTransformF",components:{ElSlider:r},setup(){let l=c(),s=c(50),j=c(50),i=c(50),_=c(0),d=c(0),f=c(0),m,k=`
