import{g as e}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-M2CGHGHN.js";e();var n=Object.freeze({displayName:"Dream Maker",fileTypes:["dm","dme"],foldingStartMarker:`(?x)
/\\*\\*(?!\\*)
...
|(?:icon|ref|[Rr]oman)(?=\\[)
|[s<>"n\\n \\[]
)`,name:"constant.character.escape.dm"},{match:"\\\\.",name:"invalid.illegal.unknown-escape.dm"}]}},scopeName:"source.dm"}),s=[n];export{s as default};
