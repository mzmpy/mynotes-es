import{a as B}from"./chunk-OOYSIAYD.js";import{Ea as F,Fa as V,G as f,N as k,P as A,U as S,V as C,ha as P,ka as b,xa as D}from"./chunk-DJZVKQMN.js";import"./chunk-NIX3CF7H.js";import{a as O}from"./chunk-PDI52H65.js";import{a as E}from"./chunk-LNJVFRMH.js";import{J as u,N as H,_ as d,d as s,e as t,na as n,va as G,x as p,y as M}from"./chunk-OXERZ7B4.js";t();G();t();t();t();G();t();var s5={"gl-canvas":{name:"src__components__mdx__constituents__threejs__scene__index-DIiWYq-gl-canvas",composes:[],isReferenced:!1}},I=(a=>l=>{if(typeof l!="string")throw new TypeError("resolveStyles: parameter 'className' must be a string.");return a[l.replace(/[A-Z]/g,h=>"-"+h.toLowerCase())].name})(s5);var X=u({name:"ThreeJsScene",setup(){let a=p(),l=p(),h=p(!0),r=p(0),q=M(),v=new P(1,6,6),j=[],w=new C,o=new f;j.push(o),w.add(o);let J=new b({emissive:16776960}),y=new k(v,J);y.scale.set(5,5,5),o.add(y);let m=new f;m.position.x=15,j.push(m),o.add(m);let W=new b({color:2241535,emissive:1122884}),T=new k(v,W);m.add(T);let i=new f;i.position.x=2,j.push(i),m.add(i);let Y=new b({color:8947848,emissive:2236962}),z=new k(v,Y);z.scale.set(.5,.5,.5),i.add(z);let Z=new D(16777215,300);w.add(Z);let N=new A(45,5/3,.1,1e3);N.position.set(0,50,0),N.up.set(0,0,1),N.lookAt(0,0,0),H(()=>{let e=new B({container:l.value});c(e,o,"solarSystem",26),c(e,y,"sun"),c(e,m,"earthOrbit"),c(e,T,"earth"),c(e,i,"moonOrbit"),c(e,z,"moon"),q.value=new S({antialias:!0,canvas:a.value}),q.value.setClearColor(0,1),q.value.setPixelRatio(10),requestAnimationFrame(_)});let c=(e,g,Q,$)=>{let l5=new R(g,$);e.add(l5,"visible").name(Q)},_=e=>{r.value===0?r.value=e*.001:r.value+=1/60,j.forEach(g=>{g.rotation.y=r.value}),q.value.render(w,N),h.value&&requestAnimationFrame(_)},K=e=>{h.value=e,requestAnimationFrame(_)};return()=>n(d,null,n(V,{animation:h.value,onAnimation:K},{canvas:()=>n("canvas",{class:I("gl-canvas"),ref:a}),sideBar:()=>n("div",{ref:l})}))}}),R=class{#l;#s=!1;constructor(l,h=10,r=10){let q=new F(h,r);q.material.depthTest=!1,q.renderOrder=1,l.add(q),this.#l=q,this.#l.visible=!1}get visible(){return this.#s}set visible(l){this.#s=l,this.#l.visible=l}};var L="../../assets/svg/scene-graph-sun-earth-moon-XWK5IRLS.svg";function U(a){let l=Object.assign({h1:"h1",ul:"ul",li:"li",p:"p",pre:"pre",code:"code",span:"span"},E(),a.components);return s.h(s.Fragment,null,s.h(l.h1,null,"\u573A\u666F\u56FE"),`
`,s.h(l.ul,null,`
`,s.h(l.li,null,`
