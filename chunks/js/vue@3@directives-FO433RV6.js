...
`),`
`),`
`))}function Q(J={}){let{wrapper:R}=Object.assign({},n(),J.components);return R?I.h(R,J,I.h(w,J)):w(J)}var B=Q;var iR=u({name:"MDX_VUE@3@DIRECTIVES",components:{MDXComponentContext:B},setup(J,R){return()=>$("div",{class:"markdown-body",style:"padding: 15px;"},$(B,{...R?.attrs}))}});export{iR as default};
