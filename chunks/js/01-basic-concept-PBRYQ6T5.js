import{a as u,b as v,c as A}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-C35OGGPY.js";import{a as L}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-IDJP7L6O.js";import{I as y,N as w,ca as N,f as a,g as t,ra as h,z as b,za as R}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-QYRLMMZP.js";t();R();t();t();t();R();t();var V={"gl-canvas":{name:"src__components__mdx__constituents__webgl__basic-concept__helloWorld__index-9iqEPq-gl-canvas",composes:[],isReferenced:!1}},T=(l=>s=>{if(typeof s!="string")throw new TypeError("resolveStyles: parameter 'className' must be a string.");return l[s.replace(/[A-Z]/g,n=>"-"+n.toLowerCase())].name})(V);var F=y({name:"WebGLHelloWorld",setup(){let l=b();return w(()=>{let n=l.value.getContext("webgl");if(!n)return;let e=`
