import{a as u,b as v,c as A}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-NUSCM57D.js";import{a as L}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-DPAERIMP.js";import{H as w,O as y,_ as N,d as a,e as t,na as h,va as R,x as b}from"https://mzmpy.github.io/mynotes-es/chunks/js/chunk-MOAQ7JNP.js";t();R();t();t();t();R();t();var V={"gl-canvas":{name:"src__components__mdx__constituents__webgl__basic-concept__helloWorld__index-9iqEPq-gl-canvas",composes:[],isReferenced:!1}},T=(l=>s=>{if(typeof s!="string")throw new TypeError("resolveStyles: parameter 'className' must be a string.");return l[s.replace(/[A-Z]/g,n=>"-"+n.toLowerCase())].name})(V);var F=y({name:"WebGLHelloWorld",setup(){let l=b();return w(()=>{let n=l.value.getContext("webgl");if(!n)return;let e=`
