...
// src/components/basicFrame/index.js
init_vue_jsxImportSource();
init_vue_runtime_esm_bundler();
...
var index_module_default = ((styles3) => {
  return (className) => {
    if (typeof className !== "string")
      throw new TypeError(`resolveStyles: parameter 'className' must be a string.`);
    return styles3[className.replace(/[A-Z]/g, (i) => "-" + i.toLowerCase())].name;
  };
})(styles);

// src/components/basicFrame/index.js
var basicFrame_default = defineComponent({
  name: "BasicFrame",
  components: {
    ElAside,
    ElContainer,
...
// src/components/asideFrame/index.js
init_vue_jsxImportSource();
init_vue_runtime_esm_bundler();
...
var App_default = defineComponent({
  name: "App",
  components: {
    BasicFrame: basicFrame_default,
    AsideFrame: asideFrame_default,
    ElMenu,
    ElMenuItem
  },
  setup(props, ctx) {
